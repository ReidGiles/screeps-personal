module.exports = {
    run: function(creep) {
        ...
        var mineralContainerR1 = Game.getObjectById("58022236a3a11f7867de5323");
        ...
        if (creep.memory.mode == "energy" && mineralContainerR1.store >= 1500 ) {
            creep.memory.mode = "mineral";
        }
        else if (creep.memory.mode == "mineral" && mineralContainerR1.store <= 300 ) {
            creep.memory.mode = "energy";
        }
        ...
        if (creep.memory.working == true) {
            ...
            if (creep.memory.room == "R1") {
                if (creep.room.name == Game.spawns.Spawn1.room.name) {
                    if (creep.carry[RESOURCE_ENERGY] != undefined) {
            ...
            if (creep.memory.room == "R1") {
                ...
                else if (creep.memory.mode == "mineral") {
                    var container = creep.pos.findClosestByPath(FIND_STRUCTURES, { filter: (s) => (s.structureType == STRUCTURE_CONTAINER
                                                                                                && s.store[RESOURCE_LEMERGIUM] > 0)
                    });
